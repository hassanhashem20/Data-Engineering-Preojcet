                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-5">
                            ...
                            <ul class="list-group list-group-flush">
                                <li class="list-group-item"><i class="bi bi-check-circle-fill text-success me-2"></i>Book Management and Cataloging</li>
                                <li class="list-group-item"><i class="bi bi-check-circle-fill text-success me-2"></i>Member Management System</li>
                                <li class="list-group-item"><i class="bi bi-check-circle-fill text-success me-2"></i>Borrowing and Return Tracking</li>
                                <li class="list-group-item"><i class="bi bi-check-circle-fill text-success me-2"></i>Reservation System</li>
                                <li class="list-group-item"><i class="bi bi-check-circle-fill text-success me-2"></i>Admin Dashboard</li>
                                <li class="list-group-item"><i class="bi bi-check-circle-fill text-success me-2"></i>User Authentication and Authorization</li>
                            </ul>
                        </div>
